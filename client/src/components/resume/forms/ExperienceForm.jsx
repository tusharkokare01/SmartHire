    ...
    return (
        <div className="bg-white rounded-2xl shadow-lg p-6 border border-slate-100">
            ...
            <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 gap-3">
                            <div>
                                <input
                                    ...
                                    className={`w-full px-4 py-2 border-2 rounded-lg outline-none ${errors.experience?.[index]?.title ? 'border-red-500' : 'border-slate-200 focus:border-emerald-500'}`}
                                />
                                {errors.experience?.[index]?.title && <p className="text-red-500 text-xs mt-1">{errors.experience[index].title.message}</p>}
                            </div>
                            ...
                            <div>
                                <input
                                    ...
                                    placeholder="Company"
                                    className={`w-full px-4 py-2 border-2 rounded-lg outline-none ${errors.experience?.[index]?.company ? 'border-red-500' : 'border-slate-200 focus:border-emerald-500'}`}
                                />
                ...
                {fields.length === 0 && <p className="text-slate-400 text-center py-4">No experience added yet</p>}
            </div>
        </div>
    );
};
